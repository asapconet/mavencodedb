...
const NavItem: React.FC<NavProps> = ({ icon: Icon, label, isActive }) => (
  <div
    className={`flex items-center h-full gap-1 cursor-pointer px-2 font-semibold truncate text-ellipsis 
...
export const NavBar: React.FC = () => {
  return (
    <nav className="hidden md:flex items-center gap-4 lg:gap-6 h-16 border-b-[1.5px] border-gray-200 px-4 lg:px-16 bg-white">
